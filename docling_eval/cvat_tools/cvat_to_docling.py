...
def is_bbox_within(
    bbox_a: BoundingBox, bbox_b: BoundingBox, threshold: float = 0.4
) -> bool:
    """
...
class CVATToDoclingConverter:
    ...
    def _get_group_for_element(
        ...
        # for path_id, element_ids in self.doc_structure.path_mappings.reading_order.items():
        #     if path_id > 0:  # For the reading orders of a level deeper than main
